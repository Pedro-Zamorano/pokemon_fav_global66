...
mixin _$Type {
 ...
 int? get slot; TypeClass? get type;
...
$TypeClassCopyWith<$Res>? get type {
  ...
  return $TypeClassCopyWith<$Res>(_self.type!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? slot,  TypeClass? type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Type() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? slot,  TypeClass? type)  $default,) {final _that = this;
switch (_that) {
case _Type():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? slot,  TypeClass? type)?  $default,) {final _that = this;
switch (_that) {
case _Type() when $default != null:
return $default(_that.slot,_that.type);case _:
  return null;
...
@override $TypeClassCopyWith<$Res>? get type;
